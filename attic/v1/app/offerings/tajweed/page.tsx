...
import { MessageCircle, Star, TrendingUp, Trophy, Brain, Target, BookOpen, GraduationCap, Rocket, Earth } from "lucide-react";
...
export default function TajweedPage() {
  ...
  return (
    <>
      <div className="page-bg-image" style={{ backgroundImage: 'url(/images/tajweed.jpg)' }} />
      <div className="py-10 space-y-12 max-w-6xl mx-auto">
      {/* 🎙️ HERO */}
      <div className="text-center space-y-6">
        <div className="flex justify-center">
          <MessageCircle className="w-20 h-20 text-brand-green" strokeWidth={2.5} />
        </div>
      ...
      <div className="fun-box-green text-white space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-4 relative z-10">
          <div className="text-center space-y-3">
            <div className="flex justify-center">
              <MessageCircle className="w-14 h-14" strokeWidth={2.5} />
            </div>
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto">
          {courses.map((course, idx) => (
            <div 
              key={course.title}
              className={`${idx % 2 === 0 ? "fun-box-gold text-brand-green-dark" : "fun-box-green text-white"} w-full md:w-[calc(50%-0.75rem)]`}
            >
      ...
      <div className="fun-box-gold text-center space-y-8 py-10">
        ...
        <p className="text-lg text-brand-green-dark font-semibold flex items-center justify-center gap-3 flex-wrap relative z-10">
          <Earth className="w-5 h-5 text-brand-green" />
