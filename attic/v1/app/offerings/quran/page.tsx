...
import { BookOpen, Star, Target, GraduationCap, Brain, Lightbulb, Rocket, Earth, Mic2, CircleDot, Minus, Pause } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto">
          {courses.map((course) => (
            <div 
              key={course.title}
              className="fun-card w-full md:w-[calc(50%-0.75rem)]"
            >
              <div className="text-center space-y-4">
      ...
      <div className="fun-box-white text-center space-y-8 py-10">
        <h2 className="text-4xl md:text-5xl font-bold text-playful gradient-text text-center relative z-10">
          Ready to Start?
        </h2>
